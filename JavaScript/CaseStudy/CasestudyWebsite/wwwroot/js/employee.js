...
$(function () {
    ...
    const add = async () => {
        try {
            ...
            // send the employee's information to the server by POST
            let response = await fetch("api/employee", {
                method: "POST",
    ...
    const buildEmployeeList = (data, usealldata = true) => {
        ...
        btn = $(`<button class="list-group-item row d-flex" id="0"><div class="col-12 text-left">...click to add employee</button>`);
