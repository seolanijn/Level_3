...
namespace khronos {
	...
	namespace civil {
		...
		*/
		...
		constexpr char const* islamic_month_name_short(month_t month) {
			constexpr char const* const names[13] = { "", "Muharram", "Safar", "RabialAwwal",
	...
	enum civil_islamic_month_codes_short { Muharram = 1, Safar, RabialAwwal, RabiathThani, JumadaIUla, JumadatTania, Rajab, Shaban, Ramadan, Shawwal,
		DhulQadah, DhuIHijja };
