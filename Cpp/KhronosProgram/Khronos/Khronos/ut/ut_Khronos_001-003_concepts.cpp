...
#if PHASE_1
TEST_PHASE(ut001_concept_am_pm_UDL, 3) {
...
#else
EMPTY_PHASE(ut001_concept_am_pm_UDL, 3)
#endif



#if PHASE_2
TEST_PHASE(ut002_concept_time_of_day, 3) {
	using namespace khronos;
...
#else
EMPTY_PHASE(ut002_concept_time_of_day,3)
#endif



#if PHASE_3
TEST_PHASE(ut003_concept_CE_BCE_to_Gregorian_astro, 3) {
	using namespace khronos;
	GATS_CHECK_EQUAL(1975_CE, 1975);
	GATS_CHECK_EQUAL(1975_BCE, -1974);
}
#else 
EMPTY_PHASE(ut003_concept_CE_BCE_to_Gregorian_astro,3)
#endif
