/*	ut_Khronos_042-043,116_julian_conv.cpp
...
#if PHASE_42 
TEST_PHASE(ut042_test_Julian_to_jd,2) {
...
#else 
EMPTY_PHASE(ut042_test_Julian_to_jd,2)
#endif
...
TEST_PHASE(ut043_jdn_to_julian_test,2) {
	using namespace khronos;
...
#else 
EMPTY_PHASE(ut043_jdn_to_julian_test,2)
#endif



#if PHASE_116 && defined( FULL_TEST )
/**	Check all conversions from the lowest Proleptic Julian date, until a day well in the future. */
TEST_PHASE(ut116_test_julian_full,1) {
	using namespace khronos;
...
#else
EMPTY_PHASE(ut116_test_julian_full,1)
#endif