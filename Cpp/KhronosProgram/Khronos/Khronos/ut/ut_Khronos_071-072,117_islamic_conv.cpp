/*	ut_khronos_071-4_islamic_conv.cpp
...
#if PHASE_71
TEST_PHASE(ut071_test_islamic_to_jd,2) {
...
#else 
EMPTY_PHASE(ut071_test_islamic_to_jd,2)
#endif
...
TEST_PHASE(ut072_test_jd_to_islamic,2) {
	using namespace khronos;
...
#else 
EMPTY_PHASE(ut072_test_jd_to_islamic,2)
#endif



/**	Check all conversions from the lowest Proleptic Islamic date, until a day well in the future. */
#if PHASE_117 && defined( FULL_TEST )
TEST_PHASE(ut117_test_islamic_full,1) {
	using namespace khronos;
...
#else 
EMPTY_PHASE(ut117_test_islamic_full,1)
#endif