...
#if PHASE_7
TEST_PHASE(ut007_gregorian_to_jdn_basic_test,3) {
...
#else
EMPTY_PHASE(ut007_gregorian_to_jdn_basic_test,3)
#endif



#if PHASE_8
TEST_PHASE(ut008_concept_gregorian_jdn_with_tod_test,3) {
	using namespace khronos;
...
#else 
EMPTY_PHASE(ut008_concept_gregorian_jdn_with_tod_test,3)
#endif
