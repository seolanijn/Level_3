...
#if PHASE_4
TEST_PHASE(ut004_test_Gregorian_leapyear_test, 3) {
...
#else 
EMPTY_PHASE(ut004_test_Gregorian_leapyear_test,3)
#endif



#if PHASE_5
TEST_PHASE(ut005_test_Gregorian_days_of_month,3) {
	using namespace khronos;
...
#else 
EMPTY_PHASE(ut005_test_Gregorian_days_of_month,3)
#endif



#if PHASE_6
TEST_PHASE(ut006_test_Gregorian_month_name, 3) {
	using namespace khronos;
...
#else 
EMPTY_PHASE(ut006_test_Gregorian_month_name,3)
#endif
