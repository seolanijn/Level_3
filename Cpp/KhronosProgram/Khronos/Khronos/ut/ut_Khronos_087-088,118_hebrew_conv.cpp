/*	ut_Khronos_087-088,118_hebrew_conv.cpp
...
#if PHASE_87 
TEST_PHASE(ut087_test_hebrew_to_jd, 1) {
...
#else
EMPTY_PHASE(ut087_test_hebrew_to_jd,1)
#endif
...
TEST_PHASE(ut088_test_jd_to_hebrew, 1) {
	using namespace khronos;
...
#else
EMPTY_PHASE(ut088_test_jd_to_hebrew,1)
#endif



#if PHASE_118 && defined( FULL_TEST )
/**	Check all conversions from the lowest Proleptic Gregorian date, until a day well in the future. */
TEST_PHASE(ut118_test_hebrew_full,1) {
	using namespace khronos;
...
#else
EMPTY_PHASE(ut118_test_hebrew_full,1)
#endif