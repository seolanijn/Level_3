...
public:
	...
	/*
	* fn:		[[nodiscard]] Operand::pointer_type evaluate( TokenList const& container );
	* brief:	it evaluates the expression
	* param:	TokenList const& container 
	* return:	Operand::pointer_type (result of the expression)
	*/
